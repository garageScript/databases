  ...
  const data = {
    ...
    html: `
        <div id="container">
          ...
          <hr>
          <div id="content">
            <p>You have requested a (re)set password token. The button below will redirect you to our website with the an autheticated token. Please click the button and set your password.</p>
